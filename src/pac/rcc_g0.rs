...
impl Rcc {
    ...
    #[inline(always)]
    pub const fn cicr(self) -> crate::pac_traits::Reg<regs::Cicr, crate::pac_traits::W> {
        unsafe { crate::pac_traits::Reg::from_ptr(self.ptr.add(0x20usize) as _) }
    }
    #[doc = "GPIO reset register"]
    #[inline(always)]
    pub const fn gpiorstr(self) -> crate::pac_traits::Reg<regs::Gpiorstr, crate::pac_traits::RW> {
        unsafe { crate::pac_traits::Reg::from_ptr(self.ptr.add(0x24usize) as _) }
    }
    #[doc = "AHB peripheral reset register"]
    #[inline(always)]
    pub const fn ahbrstr(self) -> crate::pac_traits::Reg<regs::Ahbrstr, crate::pac_traits::RW> {
        unsafe { crate::pac_traits::Reg::from_ptr(self.ptr.add(0x28usize) as _) }
    }
    #[doc = "APB peripheral reset register 1"]
    #[inline(always)]
    pub const fn apbrstr1(self) -> crate::pac_traits::Reg<regs::Apbrstr1, crate::pac_traits::RW> {
        unsafe { crate::pac_traits::Reg::from_ptr(self.ptr.add(0x2cusize) as _) }
    }
    #[doc = "APB peripheral reset register 2"]
    #[inline(always)]
    pub const fn apbrstr2(self) -> crate::pac_traits::Reg<regs::Apbrstr2, crate::pac_traits::RW> {
        unsafe { crate::pac_traits::Reg::from_ptr(self.ptr.add(0x30usize) as _) }
    }
    #[doc = "GPIO clock enable register"]
    #[inline(always)]
    pub const fn gpioenr(self) -> crate::pac_traits::Reg<regs::Gpioenr, crate::pac_traits::RW> {
        unsafe { crate::pac_traits::Reg::from_ptr(self.ptr.add(0x34usize) as _) }
    }
    #[doc = "AHB peripheral clock enable register"]
    #[inline(always)]
    pub const fn ahbenr(self) -> crate::pac_traits::Reg<regs::Ahbenr, crate::pac_traits::RW> {
        unsafe { crate::pac_traits::Reg::from_ptr(self.ptr.add(0x38usize) as _) }
    }
    #[doc = "APB peripheral clock enable register 1"]
    #[inline(always)]
    pub const fn apbenr1(self) -> crate::pac_traits::Reg<regs::Apbenr1, crate::pac_traits::RW> {
        unsafe { crate::pac_traits::Reg::from_ptr(self.ptr.add(0x3cusize) as _) }
    }
    #[doc = "APB peripheral clock enable register 2"]
    #[inline(always)]
    pub const fn apbenr2(self) -> crate::pac_traits::Reg<regs::Apbenr2, crate::pac_traits::RW> {
        unsafe { crate::pac_traits::Reg::from_ptr(self.ptr.add(0x40usize) as _) }
    }
    #[doc = "GPIO in Sleep mode clock enable register"]
    #[inline(always)]
    pub const fn gpiosmenr(self) -> crate::pac_traits::Reg<regs::Gpiosmenr, crate::pac_traits::RW> {
        unsafe { crate::pac_traits::Reg::from_ptr(self.ptr.add(0x44usize) as _) }
    }
    #[doc = "AHB peripheral clock enable in Sleep mode register"]
    #[inline(always)]
    pub const fn ahbsmenr(self) -> crate::pac_traits::Reg<regs::Ahbsmenr, crate::pac_traits::RW> {
        unsafe { crate::pac_traits::Reg::from_ptr(self.ptr.add(0x48usize) as _) }
    }
    #[doc = "APB peripheral clock enable in Sleep mode register 1"]
    #[inline(always)]
    pub const fn apbsmenr1(self) -> crate::pac_traits::Reg<regs::Apbsmenr1, crate::pac_traits::RW> {
        unsafe { crate::pac_traits::Reg::from_ptr(self.ptr.add(0x4cusize) as _) }
    }
    #[doc = "APB peripheral clock enable in Sleep mode register 2"]
    #[inline(always)]
    pub const fn apbsmenr2(self) -> crate::pac_traits::Reg<regs::Apbsmenr2, crate::pac_traits::RW> {
        unsafe { crate::pac_traits::Reg::from_ptr(self.ptr.add(0x50usize) as _) }
    }
    #[doc = "Peripherals independent clock configuration register"]
    #[inline(always)]
    pub const fn ccipr(self) -> crate::pac_traits::Reg<regs::Ccipr, crate::pac_traits::RW> {
    ...
    #[inline(always)]
    pub const fn ccipr2(self) -> crate::pac_traits::Reg<regs::Ccipr2, crate::pac_traits::RW> {
...
pub mod regs {
    ...
    impl defmt::Format for Cicr {
        fn format(&self, f: defmt::Formatter) {
            defmt::write!(
                f,
                "Cicr {{ lsirdyc: {=bool:?}, lserdyc: {=bool:?}, hsi48rdyc: {=bool:?}, hsirdyc: {=bool:?}, hserdyc: {=bool:?}, pllsysrdyc: {=bool:?}, cssc: {=bool:?}, lsecssc: {=bool:?} }}",
                self.lsirdyc(),
                self.lserdyc(),
                self.hsi48rdyc(),
                self.hsirdyc(),
    ...
    impl defmt::Format for Cifr {
        fn format(&self, f: defmt::Formatter) {
            defmt::write!(
                f,
                "Cifr {{ lsirdyf: {=bool:?}, lserdyf: {=bool:?}, hsi48rdyf: {=bool:?}, hsirdyf: {=bool:?}, hserdyf: {=bool:?}, pllsysrdyf: {=bool:?}, cssf: {=bool:?}, lsecssf: {=bool:?} }}",
                self.lsirdyf(),
                self.lserdyf(),
                self.hsi48rdyf(),
                self.hsirdyf(),
    ...
    impl defmt::Format for Cr {
        fn format(&self, f: defmt::Formatter) {
            defmt::write!(
                f,
                "Cr {{ hsion: {=bool:?}, hsikeron: {=bool:?}, hsirdy: {=bool:?}, hsidiv: {:?}, hseon: {=bool:?}, hserdy: {=bool:?}, hsebyp: {=bool:?}, csson: {=bool:?}, hsi48on: {=bool:?}, hsi48rdy: {=bool:?}, pllon: {=bool:?}, pllrdy: {=bool:?} }}",
                self.hsion(),
                self.hsikeron(),
                self.hsirdy(),
                self.hsidiv(),
